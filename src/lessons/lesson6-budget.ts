...
export const lesson6: Lesson = {
  ...
  budgetCalculator: {
    ...
    currencyLabel: "сом",
    hint: "Один клик — и таблица сама посчитает сумму доходов, расходов и остаток. Это как формула в Excel, только проще.",
  },
  steps: [
    {
      id: "s1-income",
    ...
    },
    {
      ...
      brief:
        "Это похоже на формулу в Excel: один клик — и таблица сама сложит все доходы, все расходы и покажет, сколько у тебя остаётся. Найди зелёную кнопку «Рассчитать» над таблицей и нажми её.",
