...
export const lesson1: Lesson = {
  ...
  reallifeNote:
    "Например, так в школьном буфете считают, сколько чего продали за неделю. Чтобы быстро найти нужное число, важно понимать, где колонка, а где строка.",
  ...
  steps: [
    {
      ...
      hint: "Заголовок колонки — это ячейка в самом верху со словом «Пирожки». Нажми прямо на это слово.",
      demo: {
